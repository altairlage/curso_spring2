...
@WebAppConfiguration
@ContextConfiguration(classes={JPAConfiguration.class, DataSourceConfigurationTest.class, AppWebConfiguration.class, SecurityConfiguration.class})
@ActiveProfiles("test")
	...
	public void somenteAdminDeveAcessarProdutosForm() throws Exception{
		mockMvc.perform(MockMvcRequestBuilders.get("/produtos/form")
				.with(SecurityMockMvcRequestPostProcessors
						.user("usuario@casadocodigo.com.br").password("123456")
						.roles("USUARIO")))
